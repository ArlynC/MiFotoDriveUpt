 ...
 //menu
            ...
            public void run() {
                try {
                    ...
                    if (idCarpeta == null) {
                        ...
                        //metadataFichero.setParents(Collections.singletonList("1kvuaYpHm1UqMJiI3g2xi0oja3KzFw20m"));
    ...
    public void seleccionarFoto(View v) {
        if (nombreCuenta == null) {
            ...
            seleccionFotografiaIntent.setType("image/*");//muestra todas las imagenese que tiene el usuario
